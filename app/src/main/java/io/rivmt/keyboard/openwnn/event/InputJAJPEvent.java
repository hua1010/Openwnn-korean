...
public class InputJAJPEvent extends OpenWnnEvent {
    ...
    /**
     * Generate {@link InputJAJPEvent}
     *
     * @param code      The code
     */
    public InputJAJPEvent(int code) {
        this.code = code;
    }
    /**
     * Generate {@link InputJAJPEvent} for changing the mode
     *
     * @param code      The code
     * @param mode      The mode
     */
    public InputJAJPEvent(int code, int mode) {
        this.code = code;
        this.mode = mode;
    }
    /**
     * Generate {@link InputJAJPEvent} for a inputing character
     *
     * @param code      The code
     * @param c         The inputing character
     */
    public InputJAJPEvent(int code, char c) {
        this.code = code;
        this.chars = new char[1];
        this.chars[0] = c;
    }
    /**
     * Generate {@link InputJAJPEvent} for inputing characters
     *
     * @param code      The code
    ...
    /**
     * Generate {@link InputJAJPEvent} for toggle inputing a character
     *
     * @param code          The code
     * @param toggleTable   The array of toggle inputing a character
     */
    public InputJAJPEvent(int code, String[] toggleTable) {
        this.code = code;
        this.toggleTable = toggleTable;
    }
    /**
     * Generate {@link InputJAJPEvent} for replacing a character
     *
     * @param code          The code
     * @param replaceTable  The replace table
     */
    public InputJAJPEvent(int code, HashMap<?,?> replaceTable) {
        this.code = code;
        this.replaceTable = replaceTable;
    }

    /**
     * Generate {@link InputJAJPEvent} from {@link KeyEvent}
     * <br>
     * This constructor is same as {@code InputJAJPEvent(INPUT_KEY, ev)}.
     *
     * @param ev    The key event
     */
    public InputJAJPEvent(KeyEvent ev) {
     ...
     * @param ev        The key event
     */
    public InputJAJPEvent(int code, KeyEvent ev) {
        this.code = code;
        this.keyEvent = ev;
    }
    /**
     * Generate {@link InputJAJPEvent} for selecting a candidate
     *
     * @param code      The code
     * @param word      The selected candidate
     */
    public InputJAJPEvent(int code, WnnWord word) {
        this.code = code;
        this.word = word;
    }

    /**
     * Generate {@link InputJAJPEvent} for dictionary management
     *
     * @param code      The code
     * @param dict      The type of dictionary
     * @param word      The selected candidate
     */
    public InputJAJPEvent(int code, int dict, WnnWord word) {
        this.code = code;
