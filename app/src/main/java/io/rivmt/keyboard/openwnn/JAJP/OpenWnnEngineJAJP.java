...
import io.rivmt.keyboard.openwnn.CandidateFilter;
import io.rivmt.keyboard.openwnn.ComposingText;
import io.rivmt.keyboard.openwnn.OpenWnn;
import io.rivmt.keyboard.openwnn.OpenWnnDictionaryImpl;
import io.rivmt.keyboard.openwnn.StrSegmentClause;
import io.rivmt.keyboard.openwnn.WnnClause;
import io.rivmt.keyboard.openwnn.WnnDictionary;
import io.rivmt.keyboard.openwnn.WnnEngine;
import io.rivmt.keyboard.openwnn.WnnSentence;
...
public class OpenWnnEngineJAJP implements WnnEngine {
    ...
    public OpenWnnEngineJAJP(String writableDictionaryName) {
        ...
        mDictionaryJP = new OpenWnnDictionaryImpl(
        		"/data/data/io.rivmt.keyboard.openwnn/lib/libWnnJpnDic.so",
     ...
     **********************************************************************/
    /** @see io.rivmt.keyboard.openwnn.WnnEngine#init */
    public void init() {
        clearPreviousWord();
    ...
    /** @see io.rivmt.keyboard.openwnn.WnnEngine#close */
    public void close() {}

    /** @see io.rivmt.keyboard.openwnn.WnnEngine#predict */
    ...
    /** @see io.rivmt.keyboard.openwnn.WnnEngine#convert */
    ...
    /** @see io.rivmt.keyboard.openwnn.WnnEngine#searchWords */
    ...
    /** @see io.rivmt.keyboard.openwnn.WnnEngine#getNextCandidate */
    ...
    /** @see io.rivmt.keyboard.openwnn.WnnEngine#learn */
    ...
    /** @see io.rivmt.keyboard.openwnn.WnnEngine#addWord */
    ...
    /** @see io.rivmt.keyboard.openwnn.WnnEngine#deleteWord */
    ...
    /** @see io.rivmt.keyboard.openwnn.WnnEngine#setPreferences */
    public void setPreferences(SharedPreferences pref) {}

    /** @see io.rivmt.keyboard.openwnn.WnnEngine#breakSequence */
    public void breakSequence()  {
        clearPreviousWord();
    }

    /** @see io.rivmt.keyboard.openwnn.WnnEngine#makeCandidateListOf */
    ...
    /** @see io.rivmt.keyboard.openwnn.WnnEngine#initializeDictionary */
    ...
    /** @see io.rivmt.keyboard.openwnn.WnnEngine#getUserDictionaryWords */
