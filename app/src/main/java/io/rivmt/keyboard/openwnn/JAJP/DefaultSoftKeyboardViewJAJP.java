...
import static io.rivmt.keyboard.openwnn.DefaultSoftKeyboard.*;
...
public class DefaultSoftKeyboardViewJAJP extends KeyboardView {

	private static final String TAG = "SoftKeyboardViewJAJP";
	private Context context;
	private SoftKeyboardDisplay keyboardDisplay;
	private int focusIndex = 0;

	public DefaultSoftKeyboardViewJAJP(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		keyboardDisplay = new SoftKeyboardDisplay();
	}
	...
	public void moveToNextKey(KeyEvent event) {
		Log.d(TAG, "[hangup]moveToNextKey ...........");
		Keyboard keyboard = this.getKeyboard();
